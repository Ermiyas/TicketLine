...
INSERT INTO location(id,city,country,description,postalcode,street) VALUES (1,'Voesendorf','Oesterreich','SCS','2334','SCS-Straße');
INSERT INTO location(id,city,country,description,postalcode,street) VALUES (2,'Unterpremstätten','Oesterreich','Schwarzlsee','8141',null);
INSERT INTO location(id,city,country,description,postalcode,street) VALUES (3,'Wien','Oesterreich','Flex','1010','Augartenbruecke 1');
INSERT INTO location(id,city,country,description,postalcode,street) VALUES (4,'Wien','Oesterreich','Pratersauna','1020','Waldsteingartenstraße 135');
...
INSERT INTO location(id,city,country,description,postalcode,street) VALUES (7,'Wien','Oesterreich','Wiener Staatsoper','1010','Opernring 2');

----------------------------------- Performance -----------------------------------

INSERT INTO performance(id,content,decription,durationinminutes,performancetyp) VALUES (1,'Godzilla','Als bei einem angeblichen Routine-Einsatz am Arbeitsplatz des Ehepaars Brody etwas schiefgeht und Joe Brodys (Bryan Cranston) Ehefrau ums Leben kommt, beginnt dieser unbequeme Fragen zu stellen: Was geht in dem Labor, in dem er arbeitet, vor sich? Auch die seltsamen Vorfälle und Verwüstungen in der Umgebung, die die Regierung als Folgen von Naturkatastrophen ausgibt, lassen Joe keine Ruhe. Er glaubt, dass es sich um Vertuschungsaktionen handelt, um den wahren Verursacher der Schäden zu verheimlichen: Das gigantische, radioaktive Monster Godzilla...',125,'Film');
INSERT INTO performance(id,content,decription,durationinminutes,performancetyp) VALUES (2,'X-Men: Zukunft ist Vergangenheit','Die Anführer der rivalisierenden Mutanten-Gruppen Professor X und Magneto stellen fest, dass sie nach Jahren des Kampfes gegeneinander, zusammenarbeiten müssen, um die Zukunft der Mutanten und der Welt zu sichern. Und nicht nur das: Sie brauchen auch die Hilfe der jungen Varianten ihrer Selbst, wenn sie Fehler in der Vergangenheit korrigieren wollen. Bryan Singer kehrt zum von ihm mit X-Men im Jahr 2000 initiierten Franchise um die populaeren Comic-Helden zurueck und fuehrt in einer spannenden, als Ultimate X-Men gelabelten Story die Protagonisten aus den ersten Filmen mit ihren jüngeren Alter Egos aus Erste Entscheidung zusammen',135,'Film');
INSERT INTO performance(id,content,decription,durationinminutes,performancetyp) VALUES (3,'Koenig Lear','Shakespeares duesteres Trauerspiel, das nicht nur seine Zeitgenossen verstörte, wurde 1605 in London uraufgeführt. Zum 70. Geburtstag Klaus Maria Brandauers inszeniert Peter Stein dieses literarische und theatrale Elementarereignis, eine Tragoedie, an deren Schluss – wie Jan Kott es formulierte – nur die blutige und leere Erde zurueckbleibt.',255,'Theaterstueck');
INSERT INTO performance(id,content,decription,durationinminutes,performancetyp) VALUES (4,'This is it!','Michael Jacksons letzte Tour',100,'Konzert');
INSERT INTO performance(id,content,decription,durationinminutes,performancetyp) VALUES (5,'Die Zauberfloete','Wolfgang Amadeus Mozarts berzuehmte Oper bietet eine Reihe von interpretatorischen Sichtweisen: Es kann als maerchenhaftes Zauberspiel oder als mystisches Symbolwerk verstanden werden, als ewige Auseinandersetzung von Gut und Boese oder als humanistische Botschaft. Uraufgeführt 1791 im Freihaustheater auf der Wieden zaehlt das Werk zu den meistgespielten Opern im internationalen Repertoire und kann gerade durch den Dualismus von scheinbarer Einfachheit und musikalisch tiefem Ausdruck stets aufs Neue faszinieren. An der Wiener Staatsoper wurde Die Zauberfloete bisher seit der Eröffnung 1869 mehr als 1000 Mal gegeben und kann somit auf eine reichhaltige kuenstlerische Tradition zurueckblicken.',180,'Oper');
...
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (1, '2014-05-19 21:00:00.000','1',1,1);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (2, '2014-05-19 15:00:00.000','1',1,1);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (3, '2014-05-19 21:00:00.000','1',5,1);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (4, '2014-05-19 15:00:00.000','1',5,1);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (5, '2014-05-19 21:00:00.000','2',1,2);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (6, '2014-05-19 15:00:00.000','2',1,2);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (7, '2014-05-19 21:00:00.000','2',5,2);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (8, '2014-05-19 15:00:00.000','2',5,2);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (9, '2014-05-19 21:00:00.000','1',1,1);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (10, '2014-05-21 15:00:00.000','1',1,1);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (11, '2014-05-21 21:00:00.000','1',5,1);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (12, '2014-05-21 15:00:00.000','1',5,1);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (13, '2014-05-21 21:00:00.000','2',1,2);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (14, '2014-05-21 15:00:00.000','2',1,2);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (15, '2014-05-21 21:00:00.000','2',5,2);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (16, '2014-05-21 15:00:00.000','2',5,2);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (17, '2014-05-26 18:00:00.000','Burgtheater',6,3);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (18, '2014-06-16 18:00:00.000','Burgtheater',6,3);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (19, '2014-05-26 20:15:00.000','Imaginary Room Nr.5',3,4);
INSERT INTO show(id,dateofperformance,priceincent,room,location_id,performance_id) VALUES (20, '2014-06-07 19:00:00.000','Wiener Staatsoper',7,5);
...
INSERT INTO ticket(id,show_id) VALUES (1,1);
INSERT INTO ticket(id,show_id) VALUES (2,1);
INSERT INTO ticket(id,show_id) VALUES (3,1);
INSERT INTO ticket(id,show_id) VALUES (4,1);
INSERT INTO ticket(id,show_id) VALUES (5,1);
INSERT INTO ticket(id,show_id) VALUES (6,1);
INSERT INTO ticket(id,show_id) VALUES (7,1);
INSERT INTO ticket(id,show_id) VALUES (8,1);
INSERT INTO ticket(id,show_id) VALUES (9,1);

INSERT INTO ticket(id,show_id) VALUES (10,2);
...
INSERT INTO entry(id,amount,buywithpoints,sold,article_id,basket_id,receipt_id,ticket_id) VALUES (1,1000,FALSE,FALSE,NULL,1,NULL,2);
INSERT INTO entry(id,amount,buywithpoints,sold,article_id,basket_id,receipt_id,ticket_id) VALUES (1,1000,FALSE,FALSE,NULL,1,NULL,3);
INSERT INTO entry(id,amount,buywithpoints,sold,article_id,basket_id,receipt_id,ticket_id) VALUES (1,1000,FALSE,FALSE,NULL,1,NULL,4);
INSERT INTO entry(id,amount,buywithpoints,sold,article_id,basket_id,receipt_id,ticket_id) VALUES (1,1000,FALSE,FALSE,NULL,1,NULL,5);
INSERT INTO entry(id,amount,buywithpoints,sold,article_id,basket_id,receipt_id,ticket_id) VALUES (2,1000,FALSE,FALSE,NULL,1,NULL,6);
INSERT INTO entry(id,amount,buywithpoints,sold,article_id,basket_id,receipt_id,ticket_id) VALUES (2,1000,FALSE,FALSE,NULL,1,NULL,7);
INSERT INTO entry(id,amount,buywithpoints,sold,article_id,basket_id,receipt_id,ticket_id) VALUES (2,1000,FALSE,FALSE,NULL,1,NULL,8);
INSERT INTO entry(id,amount,buywithpoints,sold,article_id,basket_id,receipt_id,ticket_id) VALUES (2,1000,FALSE,FALSE,NULL,1,NULL,9);
INSERT INTO entry(id,amount,buywithpoints,sold,article_id,basket_id,receipt_id,ticket_id) VALUES (3,1000,FALSE,FALSE,NULL,1,NULL,10);

INSERT INTO entry(id,amount,buywithpoints,sold,article_id,basket_id,receipt_id,ticket_id) VALUES (3,500,FALSE,FALSE,1,1,NULL,NULL);
