...
public class CustomerEditBaseController implements Initializable {
	private static final Logger LOG = Logger.getLogger(CustomerEditBaseController.class);

	// FXML Elemente
	@FXML
	private AnchorPane apCustomerEditBasePane;		// eigenes root pane
	@FXML
	...
	public void initialize(URL url, ResourceBundle resBundle) {
		...
		getFieldsController().setTitle("%customerpage.customer_data");				// ist eigentlich eh per Default
